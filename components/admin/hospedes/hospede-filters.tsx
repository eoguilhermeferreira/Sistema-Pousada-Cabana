...
import { statusLabels, type StatusHospede } from "@/types/hospede";
...
interface HospedeFiltersProps {
  search: string;
  onSearchChange: (value: string) => void;
  cidade: string;
  onCidadeChange: (value: string) => void;
  status: StatusHospede | "";
  onStatusChange: (value: StatusHospede | "") => void;
}

export function HospedeFilters({
  search,
  onSearchChange,
  cidade,
  onCidadeChange,
  ...
  const activeFilters = Number(Boolean(cidade)) + Number(Boolean(status));
            ...
            <div className="mt-4 space-y-4">
              ...
              <label className="flex flex-col gap-1.5">
                ...
                <select
                  ...
                  value={status}
                  onChange={(e) =>
                    onStatusChange(e.target.value as StatusHospede | "")
                  }
                >
